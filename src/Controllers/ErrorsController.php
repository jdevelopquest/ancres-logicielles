...
class ErrorsController extends Controller
{
    public function error400(): Response
    {
        ...
        $this->setViewComponent("content", "errors/error400", [], "page");
    ...
    public function error403(): Response
    {
        ...
        $this->setViewComponent("content", "errors/error403", [], "page");
    ...
    public function error404(): Response
    {
        ...
        $this->setViewComponent("content", "errors/error404", [], "page");
    ...
    public function error500(): Response
    {
        ...
        $this->setViewComponent("content", "errors/error500", [], "page");
    ...
    public function error503(): Response
    {
        ...
        $this->setViewComponent("content", "errors/error503", [], "page");
