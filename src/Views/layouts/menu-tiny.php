<aside class="menu menu-tiny hide">
    <div class="menu__submenu menu__submenu-v">
        <a class="menu__item menu__item-clickable prominent" title="Aller en haut de la page" href="#page-top"><span class="prominent__icon icon-go-top"></span></a>
    </div>
    ...
    <?php if(isset($menu)): ?>
        <?php foreach($menu as $submenu): ?>
            ...
            <?php foreach($submenu as $item): ?>
                <?= "<a class=\"menu__item menu__item-clickable prominent\" title=\"{$item['href']}\" href=\"{$item['href']}\"><span class=\"prominent__icon icon-{$item['icon']}\"></span></a>" ?>
            <?php endforeach; ?>
            <?= "</nav>" ?>
        <?php endforeach; ?>
    <?php endif; ?>
    ...
    <div class="menu__submenu menu__submenu-v">
        <a class="menu__item menu__item-clickable prominent" title="Aller au bas de la page" href="#page-bot"><span class="prominent__icon icon-go-bot"></span></a>
    </div>
</aside>
